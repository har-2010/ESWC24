...
class Model():
    ...
    def fit(self, X, y):
        ...
        self.__get_epsilon_value(self.embedding) # pour détermier quel point proche de CC dans CDBESCAN à prendre EN COMPTE DANS umpa
    ...
    def __reduce_dimensions(self, X, y):
        ...
        self.embedding = self.reducer.fit_transform(X, y) # dans y il a les hypernyms des x, si x n'a pas d'hypernm on met -1
        #print (X[0, 11])
    ...
    def __filter_relevant_terms(self):
        ...
        # print(outlying_digits.shape) : le nombre de points à enlever 
        # print(outlying_digits)
        #LocalOutlierFactor :  les termes très loin d'un ensemble de termes, de vérifier qu'on enl-ve pas des core concepts
